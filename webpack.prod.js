...
module.exports = {
    ...
    output: {
        ...
        filename: 'static/js/[name].[contenthash:10].js', // 输出的文件名称
        chunkFilename: 'static/js/[name].[contenthash:10].chunk.js', // import 导入的文件打包后输出的文件名称
    ...
    plugins: [
        new HtmlWebpackPlugin({
            template: path.resolve(__dirname, './public/index.html'), // 解析生成 HTML 首页

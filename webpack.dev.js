...
module.exports = {
    ...
    output: {
        ...
        filename: 'static/js/[name].js', // 输出的文件名称
        chunkFilename: 'static/js/[name].chunk.js', // import 导入的文件打包后输出的文件名称
    ...
    plugins: [
        ...
        new ReactRefreshWebpackPlugin() // 激活 js 的 HMR(热更新) 功能
    ],
    module: {
        // 详细 loader 配置
        rules: [
            ...
            },
            {
                ...
                use: {
                    ...
                    options: {
                        ...
                        plugins: ['react-refresh/babel'] // 激活 js 的 HMR(热更新) 功能
                    }
                },
